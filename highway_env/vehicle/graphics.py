...
class VehicleGraphics(object):
    ...
    def display(cls, vehicle: Vehicle, surface: "WorldSurface", transparent: bool = False, offscreen: bool = False,
        ...
        if isinstance(vehicle, MDPVehicle):
            #TODO: Behrad - fix this 16 by accessing lane number
            position = [*surface.pos2pix(v.position[0] - v.LENGTH / 2, v.position[1] - 16)]
            speed = vehicle.max_speed
            _rect = (position[0], position[1], surface.pix(speed*6), surface.pix(32))

            # pygame.draw.rect(surface, cls.RED, _rect, 2)
