...
class EnvViewer(object):
    ...
    def __init__(self, env: 'AbstractEnv') -> None:
        ...
        self.frame = 0
        self.directory = "/home/rodolfo/PycharmProjects/coop_repo/images/"
    ...
    #     panel_size = (self.env.config["screen_width"], self.env.config["screen_height"])
    #
    #     _sim_surface = WorldSurface(panel_size, 0, pygame.Surface(panel_size))
    #     _sim_surface.scaling = self.env.config.get("scaling", self.sim_surface.INITIAL_SCALING)
    #     _sim_surface.centering_position = self.env.config.get("centering_position", self.sim_surface.INITIAL_CENTERING)
    #
    #     RoadGraphics.display(self.env.road, _sim_surface)
    #
    #     ######################
    #     surface = _sim_surface
    #     from PIL import Image
    ...
    #     ######################
    #
    #     _window_position = self.window_position()
    #     _sim_surface.move_display_window_to(_window_position)
    ...
    #     """a heatmap to be used in HeatmapObservation."""
    #     self.render_heatmap()
    #     surface = self.screen if self.env.config["render_agent"] and not self.offscreen else self.sim_surface
    #     data = pygame.surfarray.array3d(surface)
    #     return np.moveaxis(data, 0, 1)
